...
if __name__ == "__main__":
    ...
    alphas = [alpha_2, alpha_3, alpha_4]
    nbasis = list(map(len, alphas))
    problems = [construct_problem(alpha) for alpha in alphas]
    energies = [
        solve_problem(*problem)[0][1] for problem in problems
    ...
    plt.title("First excited state energies as a function of the number of basis functions")
    plt.savefig("1_b.pdf")
