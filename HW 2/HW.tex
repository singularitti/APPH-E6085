...
\title{Solving \ce{He} and \ce{H2} within Hartree--Fock}		% Title
\author{}								% Author
\date{}											% Date
...
\begin{enumerate}[(a)]
    \item The Hamiltonian is $H = - \frac{1}{2} \nabla^2 -
              \frac{1}{r}$\thinspace,
          ...
          \begin{equation}
              \begin{aligned}
                  \nabla^2 & = \frac{1}{r} \frac{\partial^2}{\partial
                      r^2} r
                  - \frac{\bm{l}^2}{\hbar^2 r^2}                      \\
                           & = \frac{1}{r} \frac{\partial^2}{\partial
                      r^2}r+{\frac {1}{r^{2}\sin \theta }}{\frac {\partial
                  }{\partial \theta }}\Big(\sin \theta {\frac {\partial
                      }{\partial \theta }}\Big)+{\frac {1}{r^{2}\sin
                      ^{2}\theta }}{\frac {\partial^{2}}{\partial \varphi
                      ^{2}}} \thinspace,
              \end{aligned}
          \end{equation}
          ...
          \begin{figure}[h]
              \centering
              \includegraphics[width=0.5\linewidth]{pro_1_a.pdf}
              \caption{Ground state energy as a function of $n$.}
              \label{fig:pro1a}
          \end{figure}
    \item For the energy of the first excited state (ie. second lowest Eigenvalue)
          ...
          \begin{figure}[h]
              \centering
              \includegraphics[width=0.5\linewidth]{pro_1_b.pdf}
              \caption{Energy of the first excited state as a function of $n$.}
              \label{fig:pro1b}
          \end{figure}
    \item By solving eigenvalue problem we derive coefficients, that is,
          $\begin{pmatrix}
                  c_1 & c_2 & c_3 & c_4
          ...
          \begin{figure}[h]
              \centering
              \includegraphics[width=0.5\linewidth]{pro_1_c.pdf}
          ...
          \begin{figure}[h]
              \subfigure[Density as a function of $r$.]{
                  ...
                  \begin{minipage}[b]{0.5\textwidth}
                      \centering
                      \includegraphics[width=\linewidth]{pro_2_a_1.pdf}
                  \end{minipage}}
              \hfill
              \subfigure[Radial probability distribution as a function of $r$.]{
                  ...
                  \begin{minipage}[b]{0.5\textwidth}
                      \centering
                      \includegraphics[width=\linewidth]{pro_2_a_2.pdf}
                  \end{minipage}}
              \caption{Problem $2(a)$.}
              \label{fig:2-a}   %% label for entire figure
          \end{figure}
    \item Now consider the single-electron
          ...
          \begin{figure}[h]
              \subfigure[The total energy $\varepsilon$ as a function of iteration $n$.]{
                  ...
                  \begin{minipage}[b]{0.5\textwidth}
                      \centering
                      \includegraphics[width=\linewidth]{pro_2_b_1.pdf}
                  \end{minipage}}
              \hfill
              \subfigure[The interaction density compared with the non-interacting density.]{
                  ...
                  \begin{minipage}[b]{0.5\textwidth}
                      \centering
                      \includegraphics[width=\linewidth]{pro_2_b_2.pdf}
                  \end{minipage}}
              \caption{Problem $2(b)$.}
...
\begin{enumerate}[(a)]
    \item By neglecting the electron-electron interactions, we have
          \begin{equation}
              H = - \frac{1}{2}\nabla_1^2
              - \frac{1}{2}\nabla_2^2
          ...
          \begin{figure}[h]
              \centering
              \includegraphics[width=0.5\linewidth]{pro_3_a.pdf}
    ...
    \item Now the Hamiltonian becomes
          \begin{multline}
              H = - \frac{1}{2}\nabla_1^2
              - \frac{1}{2}\nabla_2^2
              - \frac{1}{\lvert \bm{r}_1 - \bm{R}_1 \rvert} - \frac{1}{\lvert \bm{r}_1 - \bm{R}_2 \rvert}\\
    ...
    \item The Hamiltonian is still the same, but Schr\"{o}dinger equation will be
