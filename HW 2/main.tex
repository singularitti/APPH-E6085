...
\begin{equation}
    \begin{aligned}
        ...
        \int \phi_i^\ast H \phi_j \, d\symbf{r} \\
                                     & =
...
\begin{equation}
    \Big(- \frac{1}{2}\nabla^2 - \frac{2}{r} \Big) \psi(\symbf{r}) = E \psi(\symbf{r}).
\end{equation}
...
$\Psi_{\text{exact}}(\symbf{r}_1, \symbf{r}_2) = \frac{8}{\pi}
...
Schr\"{o}dinger equation of $\psi_1(\symbf{r}_1)$ will be
\begin{equation}
    \Big(- \frac{1}{2}\nabla_1^2 - \frac{2}{r_1}
    + \int \frac{\psi_2^\ast(\symbf{r}_2)\psi_2(\symbf{r}_2)}{\lvert \symbf{r}_1 -
        \symbf{r}_2 \rvert} d\symbf{r}_2 \Big) \psi_1(\symbf{r}_1) = E \psi_1 (\symbf{r}_1),
\end{equation}
with $\psi_2(\symbf{r}_2) = 0.08704173 e^{-0.298073 r^2}
...
\begin{equation}
    \begin{aligned}
        \int \frac{\psi_2^\ast(\symbf{r}_2)\psi_2(\symbf{r}_2)}{\lvert \symbf{r}_1 -
            \symbf{r}_2 \rvert} d\symbf{r}_2
         & = \sum_{i, j}
        c_i^\ast c_j
        \int
        \frac{\phi_i^\ast(r_2) \phi_j(r_2)}{\lvert \symbf{r}_1 - \symbf{r}_2 \rvert}
        \, d\symbf{r}_2  \\
         & = \sum_{i, j}
        2\pi c_i^\ast c_j
...
\begin{equation}
    \begin{aligned}
        \Braket{ \phi_i(\symbf{r}_1) | - \frac{1}{2}\nabla_1^2 -
            \frac{2}{r_1} | \psi_1(\symbf{r}_1) } +
        \Braket{\phi_i(\symbf{r}_1) |
            \int \frac{\psi_2^\ast(\symbf{r}_2)\psi_2(\symbf{r}_2)}{\lvert
                \symbf{r}_1 - \symbf{r}_2 \rvert} d\symbf{r}_2 | \psi_1(\symbf{r}_1)}
        = E \braket{\phi_i(\symbf{r}_1) |
            \psi_1(\symbf{r}_1)}.
    \end{aligned}
\end{equation}
...
\end{equation}
Derive new set of $\{ c_1, c_2, c_3, c_4\}$, let $\psi_1(\symbf{r}_1) =
    \sum_{i=1}^{4} c_i \phi_i(\symbf{r}_1)$, and substitute
into
\begin{equation}
    \Big(- \frac{1}{2}\nabla_2^2 - \frac{2}{r_2}
    + \int \frac{\psi_1^\ast(\symbf{r}_1)\psi_1(\symbf{r}_1)}{\lvert \symbf{r}_1 -
        \symbf{r}_2 \rvert} d\symbf{r}_1 \Big) \psi_2(\symbf{r}_2) = E \psi_2 (\symbf{r}_2),
\end{equation}
...
\begin{equation}
    ...
    \int \frac{\psi_1^\ast(\symbf{r}_1)\psi_2^\ast(\symbf{r}_2) \psi_1(\symbf{r}_1)
        \psi_2(\symbf{r}_2)}{\lvert
        \symbf{r}_1 - \symbf{r}_2 \rvert}\, d\symbf{r}_2 \, d\symbf{r}_1,
\end{equation}
...
\end{equation}
so corresponding Schr\"{o}dinger equation of $\psi_1(\symbf{r}_1)$ is
\begin{equation}
    \Big(- \frac{1}{2}\nabla_1^2
    - \frac{1}{\lvert \symbf{r}_1 - \symbf{R}_1 \rvert}
    - \frac{1}{\lvert \symbf{r}_1 - \symbf{R}_2 \rvert}
    + \frac{1}{\lvert \symbf{R}_1 -
        \symbf{R}_2 \rvert} \Big) \psi_1(\symbf{r}_1)
    = E \psi_1 (\symbf{r}_1).
\end{equation}
Left multiplied by $\Big( \phi_i^{R_m} \Big)^\ast(\symbf{r}_1)$ and integrate, we have
\begin{equation}
    \Braket{\phi_i^{R_m} |
        - \frac{1}{2}\nabla_1^2
        - \frac{1}{\lvert \symbf{r}_1 - \symbf{R}_1 \rvert}
...
$N^E_{ij, mn}=\Braket{\phi_i^{R_m} |
        -\frac{1}{\lvert \symbf{r} - \symbf{R}_1 \rvert } | \phi_j^{R_n} }
    + \Braket{\phi_i^{R_m} |
        -\frac{1}{\lvert \symbf{r} - \symbf{R}_2 \rvert } | \phi_j^{R_n} }$,
$N^N_{ij} = \Braket{\phi_i^{R_m} |
        \frac{1}{\lvert \symbf{R}_1 - \symbf{R}_2 \rvert } | \phi_j^{R_n} }$,
and
...
\begin{equation}
    \begin{aligned}
        E_{\text{total}} & = 2 E - \Braket{\psi | \frac{1}{\lvert \symbf{R}_1 - \symbf{R}_2 \rvert } | \psi}
                         & = 2 E - \frac{1}{\lvert \symbf{R}_1 - \symbf{R}_2 \rvert},
    \end{aligned}
\end{equation}
...
for reference. The minimum point is when $\lvert \symbf{R}_1- \symbf{R}_2 \rvert = \SI{1.3462}{\bohr}$(close
...
\begin{multline}\label{eq:psi1}
    ...
    + \frac{1}{\lvert \symbf{R}_1 -
        \symbf{R}_2 \rvert}\\
    + \int d\symbf{r}_2
    \frac{ \psi_2 ^\ast  (\symbf{r}_2) \psi_2(\symbf{r}_2) - \psi_2 ^\ast  (\symbf{r}_2) \hat{P} \psi_2(\symbf{r}_2)}%
    {\lvert \symbf{r}_1 - \symbf{r}_2 \rvert}
    \bigg) \psi_1(\symbf{r}_1)
    = E_1  \psi_1(\symbf{r}_1),
\end{multline}
and
\begin{multline}\label{eq:psi2}
    ...
    + \frac{1}{\lvert \symbf{R}_1 -
        \symbf{R}_2 \rvert}\\
    + \int d\symbf{r}_1
    \frac{ \psi_1 ^\ast  (\symbf{r}_1) \psi_1(\symbf{r}_1) - \psi_1 ^\ast  (\symbf{r}_1) \hat{P} \psi_1(\symbf{r}_1)}%
    {\lvert \symbf{r}_1 - \symbf{r}_2 \rvert}
    \bigg) \psi_2(\symbf{r}_2)
    = E_2  \psi_2(\symbf{r}_2),
\end{multline}
